...
import './ZonasIndexPage.css';

/* ══════════════════════════════════════════════
   ZONAS INDEX — Hub page listing all CMS landing
   pages as a card repeater. Exists for SEO
...
export default function ZonasIndexPage() {
  ...
  useEffect(() => {
    ...
    fetchLandingZonas()
      ...
      .catch((err) => console.warn('[ZonasIndex]', err))
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            entry.target.querySelectorAll('.zi-stagger').forEach((el, i) => {
      ...
      <section className="zi-hero">
        <div className="container zi-hero-inner zi-reveal">
          ...
          <p className="zi-hero-sub zi-stagger">
            ...
            cómo podemos proteger tu operación laboral y mercantil.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          {loading ? (
            ...
            <div className="zi-empty zi-reveal">
              <div className="zi-empty-icon">⚖️</div>
                ...
                {pages.map((page, i) => (
                  ...
                  >
                    ...
                    <div className="zi-card-actions">
                      <Link to={`/${page.slug}`} className="zi-btn zi-btn--page">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
